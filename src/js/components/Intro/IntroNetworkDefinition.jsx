...
import listenToFriends from "../../../img/global/intro-story/intro-listen-to-friends-graphic.svg";
...
export default class IntroNetworkDefinition extends Component {
  ...
  render () {
    ...
    return (
      <div
        className="intro-story__background background--image4"
      ...
      >
        ...
        <div><br /></div>
        <div><img className="center-block intro-story__img-height--extra u-bg-white" src={cordovaDot(listenToFriends)} /></div>
