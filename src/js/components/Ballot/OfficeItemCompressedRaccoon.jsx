...
export default class OfficeItemCompressedRaccoon extends Component {
  ...
  render () {
    ...
    const candidatePreviewLimit = NUMBER_OF_CANDIDATES_TO_DISPLAY;
                ...
                if (atLeastOneCandidateChosenByNetwork) {
                  ...
                  networkOrIssueScoreSupport = candidateWithMostSupportFromNetwork === oneCandidate.ballot_item_display_name ? (
                    <div className="u-flex u-items-center">
                      <div
                        className="o-media-object u-flex-auto u-min-50 u-push--sm u-stack--sm u-cursor--pointer"
                        ...
                        >
                          ...
                          <div className="o-media-object__body u-flex u-flex-column u-flex-auto u-justify-between">
                            ...
                            <div>
                              ...
                              >
                                <div>
                                  <span className="u-push--xs u-cursor--pointer">
                                    Has the highest
